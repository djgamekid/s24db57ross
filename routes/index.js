...
router.get('/', function (req, res) {
  res.render('index', { title: 'Rectangle App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'Rectangle App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'Rectangle App Login', user: req.user });
});
